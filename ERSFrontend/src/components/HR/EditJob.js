                        ...
                        <Card.Body>
                          ...
                          <Row>
                            <Card.Text style={{ color: "white" }}>
                              <h6>Job Desc: {job.jobDesc}</h6>
                              <h6>Salary  :   {job.salary}</h6>
                              <h6>Skills  :   {job.skillset}</h6>
                              <h6>
                                Start Date: &nbsp;&nbsp;
                                {moment(job.startDate).format("DD/MM/YY")}
                              </h6>
                              <h6>
                                Apply By  :   &nbsp;&nbsp;
                              {moment(job.applyBy).format("DD/MM/YY")}
                              </h6>
                              <h6>Location: {job.location}</h6>
                              <h6>Years Of Exp: {job.yearsOfExp}</h6>
                              <h6></h6>
                            ...
                            <div className="centerItems">
                              <Link to={`/JobDetails/${job._id}`}>
                                <Button className="btn-grad">Edit Job</Button>
                              </Link>
                              <br></br>
                            </div>
                          </Row>
